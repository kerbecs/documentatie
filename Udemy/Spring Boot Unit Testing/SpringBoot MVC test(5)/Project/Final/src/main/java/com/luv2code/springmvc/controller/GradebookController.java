...
public class GradebookController {
	...
	@PostMapping("/")
	public String postStudent(@ModelAttribute("student") CollegeStudent collegeStudent,Model model){
		studentService.createStudent(collegeStudent.getFirstname(),collegeStudent.getLastname(),collegeStudent.getEmailAddress());
